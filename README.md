...
> [!NOTE]
> If you are using your own *mdp* files, don't forget to add the free energy inputs at the transitions *mdp*:
> ```mdp
...
Change the values that need to be change in the main function of `prepare_inputs_md.py` and run it to generate the folder containing all the initial files. This will generate a folder with the name you chose containing the following folders:
